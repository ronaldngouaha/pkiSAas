// Bicep skeleton for service: Admin.Pki
...
param serviceName string = 'admin.pki'
...
output status string = 'Skeleton for Admin.Pki generated. Fill resources before deployment.'
