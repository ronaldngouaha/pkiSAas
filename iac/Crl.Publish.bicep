// Bicep skeleton for service: Crl.Publish
...
param serviceName string = 'crl.publish'
...
output status string = 'Skeleton for Crl.Publish generated. Fill resources before deployment.'
