// Bicep skeleton for service: Tenants.Identity
...
param serviceName string = 'tenants.identity'
...
output status string = 'Skeleton for Tenants.Identity generated. Fill resources before deployment.'
