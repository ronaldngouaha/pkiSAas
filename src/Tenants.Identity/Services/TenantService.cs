...
namespace Acme.Pki.Tenants.Identity.Services
{
    public class TenantService : ITenantService
    {
        ...
        public async Task<TenantDto> CreateAsync(TenantCreateDto dto, Guid createdBy)
        {
            ...
            return new TenantDto { Id = tenant.Id, Name = tenant.Name, Slug = tenant.Slug, PrimaryDomain = tenant.PrimaryDomain, CreatedBy = tenant.CreatedBy, PlanTier = tenant.PlanTier, MaxCertificates = tenant.MaxCertificates, Metadata = tenant.Metadata, IsActive = tenant.IsActive, IsSuspended = tenant.IsSuspended, CreatedAt = tenant.CreatedAt, Domains = dto.Domains ?? new List<string>() };
        }
        ...
        public async Task<TenantDto> GetAsync(Guid tenantId)
        {
            ...
            return new TenantDto { Id = t.Id, Name = t.Name, Slug = t.Slug, PrimaryDomain = t.PrimaryDomain, CreatedBy = t.CreatedBy, PlanTier = t.PlanTier, MaxCertificates = t.MaxCertificates, Metadata = t.Metadata, IsActive = t.IsActive, IsSuspended = t.IsSuspended, CreatedAt = t.CreatedAt, Domains = domains };
        }
        ...
        public async Task<TenantDto> SuspendAsync(Guid tenantId, string reason)
        {
            var t = await _db.Tenants.FindAsync(tenantId);
        ...
        public async Task<IEnumerable<TenantDto>> ListAsync(int page = 1, int pageSize = 50)
        {
            ...
            foreach (var t in tenants)
            {
                ...
                result.Add(new TenantDto { Id = t.Id, Name = t.Name, Slug = t.Slug, PrimaryDomain = t.PrimaryDomain, CreatedBy = t.CreatedBy, PlanTier = t.PlanTier, MaxCertificates = t.MaxCertificates, Metadata = t.Metadata, IsActive = t.IsActive, IsSuspended = t.IsSuspended, CreatedAt = t.CreatedAt, Domains = domains });
            }
            return result;
        }
    }
